            ...
            switch (action) {
                case 'add_estimation':
                    updates = {
                        ...
                        estimation: { ...data, estimatedBy: req.user.name, estimatedAt: new Date().toISOString() }
                    };
                ...
                case 'set_pricing':
                    updates = {
                        ...
                        pricing: { ...data, pricedBy: req.user.name, pricedAt: new Date().toISOString() }
                    };
                ...
                case 'director_approve':
                    updates = {
                        status: 'approved',
                        directorApproval: { approved: true, ...data, approvedBy: req.user.name, approvedAt: new Date().toISOString() }
                    };
                ...
                case 'director_reject':
                     updates = {
                        status: 'rejected',
                        directorApproval: { approved: false, ...data, rejectedBy: req.user.name, rejectedAt: new Date().toISOString() }
                    };
                    activityDetail = `Director rejected proposal`;
                    break;
